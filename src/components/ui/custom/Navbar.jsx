...
function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 py-2 backdrop-blur-lg border-b border-neutral-700/80">
      <div className="flex items-center sm:justify-between justify-evenly px-5 text-gray-300">
        ...
        <div className="max-md:hidden md:block">
          <ul className="flex gap-10 justify-evenly text-lg">
            {navLinks.map((navlink, index) => (
              <li key={index} className="cursor-pointer  hover:scale-105 transition-all ease-in-out hover:underline">
                {navlink}
              </li>
            ))}
          </ul>
